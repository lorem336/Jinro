...
> [!WARNING]
> Dưới đây là danh sách các tệp/ứng dụng bắt buộc phải có
...
> - Chọn 1 phiên bản termux phù hợp với kiến trúc cpu **Không hoạt động với máy 32bit kiến trúc x86 và armeabi-v7a**
